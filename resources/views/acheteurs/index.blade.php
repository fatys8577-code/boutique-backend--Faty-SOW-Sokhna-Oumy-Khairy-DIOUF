...
>>>>>>> b5ccde3bd330e0a8b162e8e95ac1c9d1f1050077
                            + Nouvel acheteur
                        </a>
                    @endcan
                </div>
                        ...
                        @forelse ($acheteurs as $acheteur)
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="py-2 space-x-2">
                                    ...
                                    <a href="{{ route('acheteurs.show', $acheteur) }}"
                                       class="text-blue-600 hover:underline">
                                        Voir
                                    </a>

                                    @can('gerer-catalogue')
                                        <a href="{{ route('acheteurs.edit', $acheteur) }}"
                                           class="text-yellow-600 hover:underline">
                                            Modifier
                                        </a>

                                        <form action="{{ route('acheteurs.destroy', $acheteur) }}"
                                              method="POST"
                                              class="inline"
